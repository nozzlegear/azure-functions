...
const $$TallyTemplate_fields_artist =
    const DeclarationMirror(name: 'artist', type: String);
...
const TallyTemplateClassMirror =
  ...
  '': const FunctionMirror(
      ...
      positionalParameters: const [
        const DeclarationMirror(name: 'artist', type: String, isRequired: true),
        const DeclarationMirror(name: 'count', type: int, isRequired: true)
      ],
      $call: _TallyTemplate__Constructor)
}, fields: const {
  'artist': $$TallyTemplate_fields_artist,
...
_initMirrors() {
  initClassMirrors({
    TallyResponse: TallyResponseClassMirror,
